...
# Небольшие комментария по принятым решениям

Нет сомнения, что практики, требуемые от нас в задании полезны и облегчают жизни многим программистам. В процессе курса у меня развилось хорошее понимание и обзор на инструменты. Однако на текущем этапе развития проекта - а он находится в стадии прототипирования и доработки, а не полноценного обучения и сервиса, dvc не является необходимым. Вместо этого используется простой sample данных, чтобы обкатать решение.

С другой стороны использование дальновидных практик, основывается на предположении что продукт будет жить долго, будет развиваться и будет полезен. В этом также заключена мотивация разработчика в их использовании, однако этот проект, в связи с семейными, учебными и временными рамками, не имел возможности развиться, что уменьшает мотивацию использования дальновидных практик "как в проде". Поэтому мной принято решение, организовать проект с использованием основных предложенных техник так, чтобы это не доставляло больших затруднений, чем в этом есть пользы, и некоторые пункты находятся в зачатном состоянии так - что при необходимости их можно развить в будущем.
